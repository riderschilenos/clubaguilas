                ...
                @if ($suscripcion_activa)
                    <div class='flex items-center justify-center my-12'>  <div class="rounded-xl border p-5 shadow-md w-9/12 bg-white">
                        <div class="flex w-full items-center justify-between border-b pb-3">
                            ...
                            <div class="mt-4 mb-6">
                            <div class="mb-3 text-xl font-bold">Hola, tu suscripcion esta activa hasta el: {{date('d/m/Y', strtotime($suscripcion_activa->end_date))}}</div>
                                ...
                                <div class="lg:pr-10">
                                    ...
                                    <div class="mb-6 pb-6 border-b border-gray-200 text-gray-800">
                                        ...
                                        <div class="w-full flex items-center">
                                            ...
                                            <div class="pl-3">
                                                <span class="font-semibold">{{date('d/m/Y', strtotime($suscripcion->end_date))}}</span>
                                            </div>
                                        </div>
                            ...
                            <div class="my-5 max-w-4xl justify-center content-center mx-auto">
                                ...
                                <div class="flex justify-between items-center border-b border-slate-200 py-3 px-2 border-l-4  border-l-transparent bg-gradient-to-r from-transparent to-transparent hover:from-slate-100 transition ease-linear duration-150">
                                    <div class="inline-flex items-center space-x-2">
                                        ...
                                        <div>Matricula 
                                            @if ($matricula_activa)
                                                (Vence el {{date('d/m/Y', strtotime($matricula_activa->end_date))}})
                                            @endif
                                        </div>
                                    </div>
                                    <div>
                    ...
                    <div class="lg:pr-10">
                        ...
                        <div class="mb-6 pb-6 border-b border-gray-200 text-gray-800">
                            ...
                            <div class="w-full flex items-center">
                                ...
                                <div class="pl-3">
                                    <span class="font-semibold">{{date('d/m/Y', strtotime($suscripcion_rechazada->end_date))}}</span>
                                </div>
                            </div>
                            <div class="w-full flex mb-3 items-center">
                                <div class="flex-grow">
                ...
                @else
                    @if ($plan) 
                        ...
                        <div class="flex justify-center">
                            <button wire:click="plan_clean" class="mt-6 rounded-lg bg-red-600 px-6 py-2.5 text-center text-sm font-medium capitalize leading-5 text-white hover:bg-red-500 focus:outline-none mx-2 lg:w-auto">Cancelar</button>
                            @if ($plan==1)
                                <button wire:click="set_siguiente" class="whitespace-nowrap mt-6 rounded-lg bg-green-600 px-6 py-2.5 text-center text-sm font-medium capitalize leading-5 text-white hover:bg-green-500 focus:outline-none mx-2 lg:w-auto">Pagar Sin Incluir Siguiente Més</button>
